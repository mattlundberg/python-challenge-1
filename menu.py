        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                # Tell the customer that their input isn't valid
                    ...
                    print(f"{menu_selection} was not a menu item option. Please select a valid menu item option.")    


            # Tell the customer they didn't select a menu option
            else:
                print("Please enter a valid menu item number option.")

        else:
            # Tell the customer they didn't select a menu option
            print(f"{menu_category} was not a menu option. Please select a valid menu option.")
    else:
